      ...
      <header className="border-2 border-[#27272A] bg-white rounded-lg p-4 flex items-center justify-between shadow-[3px_3px_0px_#27272A] max-w-6xl mx-auto w-full">
        ...
        <div className="flex items-center gap-3">
          {loggedIn ? (
            ...
            <>
              <Link to="/login">
                <Button variant="ghost" className="font-bold text-xs">
                  Log In
                </Button>
              </Link>
              <Link to="/signup">
      ...
      <main className="max-w-6xl mx-auto w-full py-12 space-y-16">
        <div className="bg-white border-2 border-[#27272A] shadow-[4px_4px_0px_#27272A] rounded-xl p-8 md:p-12 space-y-6">
          <Badge className="bg-amber-200 text-[#27272A] border-1.5 border-[#27272A] font-bold text-xs px-3.5 py-1 gap-1.5">
            <TrendingUp className="h-3.5 w-3.5" /> Built Exclusively for Indian
            Equities (NSE & BSE)
          </Badge>
          ...
          <p className="text-base sm:text-lg text-[#52525B] max-w-3xl font-normal leading-relaxed">
            Stop wasting hours sifting through balance sheets, technical charts,
            and corporate filings. Finance Agent acts as your dedicated CFA,
            executing stock queries, calculating risk-adjusted portfolio
            metrics, and recommending optimal asset allocations.
          </p>
              ...
              <>
                ...
                <Link to="/portfolios">
                  <Button className="neubrutal-btn text-sm px-8 h-12 gap-2">
                    <PieChart className="h-4 w-4 text-indigo-600" /> View
                    Portfolios
                  </Button>
                </Link>
              </>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="bg-white border-2 border-[#27272A] shadow-[3px_3px_0px_#27272A] rounded-lg">
              <CardHeader className="space-y-2">
                ...
                <CardTitle className="font-display font-bold text-lg text-[#27272A]">
                  Technical Analysis
                </CardTitle>
                <CardDescription className="text-xs text-[#52525B]">
                  Computes RSI 14, MACD, SMA 20/50/200, and Bollinger Bands on
                  command to give you immediate buy/sell indicator signals.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-white border-2 border-[#27272A] shadow-[3px_3px_0px_#27272A] rounded-lg">
              <CardHeader className="space-y-2">
                ...
                <CardDescription className="text-xs text-[#52525B]">
                  Instantly fetches balance sheets, income statements, cash flow
                  reports, SEC/BSE corporate filings, and press releases.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-white border-2 border-[#27272A] shadow-[3px_3px_0px_#27272A] rounded-lg">
              <CardHeader className="space-y-2">
                ...
                <CardDescription className="text-xs text-[#52525B]">
                  Executes Hierarchical Risk Parity (HRP) covariance cluster
                  optimization and recommends target weight percentages in a
                  clean table.
                </CardDescription>
              </CardHeader>
            </Card>
        ...
        <div className="bg-white border-2 border-[#27272A] shadow-[4px_4px_0px_#27272A] rounded-xl p-8 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 pt-2">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-bold text-sm text-[#27272A]">
                  Analyst Predictions
                </h3>
                <p className="text-xs text-[#52525B]">
                  Target price highs/lows and consensus recommendations
                  (Buy/Hold/Sell).
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-bold text-sm text-[#27272A]">
                  Indian Indices Tracking
                </h3>
                <p className="text-xs text-[#52525B]">
                  Real-time status for NIFTY 50, SENSEX, NIFTY Bank, and sector
                  indices.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#52525B]">
                  Screen top stocks by sector (Defense, IT, Banking, Auto,
                  Pharma, Renewables).
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#52525B]">
                  Computes Sharpe Ratio, Sortino Ratio, Beta, and Alpha against
                  NIFTY 50.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#52525B]">
                  Organize up to 10 watchlists with 50 stocks each, linked
                  directly to Yahoo Finance.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#52525B]">
                  Global stock search redirects directly to official stock quote
                  pages.
                </p>
              </div>
            </div>
