...
import { MessageSquare, PieChart, Eye, ArrowRight, Bot } from "lucide-react"
    ...
    <div className="space-y-6 text-[#27272A]">
      ...
      <div className="bg-white border-2 border-[#27272A] shadow-[4px_4px_0px_#27272A] rounded-lg p-6 space-y-3">
        <div className="flex items-center gap-2">
          ...
          <span className="font-display font-extrabold text-lg">FinCFA Agent Workspace</span>
        </div>
        ...
        <p className="text-xs text-[#52525B]">
          Your CFA agent is active. Analyze Indian stock tickers, compute Sharpe & Sortino portfolio metrics, and request HRP weight allocations.
        </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="bg-white border-2 border-[#27272A] shadow-[3px_3px_0px_#27272A] rounded-lg">
          <CardHeader>
            ...
            <CardTitle className="font-display font-bold text-base">Chat Terminal</CardTitle>
            <CardDescription className="text-xs text-[#52525B]">
              Stream answers, technical indicators (RSI, MACD), balance sheets & HRP weightings.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Link to="/chat">
              <Button variant="ghost" size="sm" className="w-full justify-between font-bold text-xs text-[#2563EB]">
        ...
        <Card className="bg-white border-2 border-[#27272A] shadow-[3px_3px_0px_#27272A] rounded-lg">
          <CardHeader>
            ...
            <CardTitle className="font-display font-bold text-base">Portfolios</CardTitle>
            <CardDescription className="text-xs text-[#52525B]">
              Track buy price, average price, Sharpe ratio, Sortino ratio, Beta, and Alpha vs NIFTY 50.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Link to="/portfolios">
              <Button variant="ghost" size="sm" className="w-full justify-between font-bold text-xs text-indigo-600">
        ...
        <Card className="bg-white border-2 border-[#27272A] shadow-[3px_3px_0px_#27272A] rounded-lg">
          <CardHeader>
            ...
            <CardTitle className="font-display font-bold text-base">Watchlists</CardTitle>
            <CardDescription className="text-xs text-[#52525B]">
              Manage up to 10 watchlists with 50 stocks each. Direct external Yahoo Finance links included.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Link to="/watchlists">
              <Button variant="ghost" size="sm" className="w-full justify-between font-bold text-xs text-amber-600">
